...
class NH_Notifications_Table extends WP_List_Table {
    ...
    /**
     * Previous seen timestamp (used to highlight new rows).
     *
     * @since 1.6.2
     * @var string
     */
     ...
     *
     * @since 1.6.2
     * @param string $status_filter Status filter (all/unread/archived/important).
     * @param string $prev_seen Previous seen timestamp.
     */
    ...
    protected function get_bulk_actions() {
        ...
        // Archive/unarchive depends on current view.
    ...
    /**
     * Process bulk actions (non-AJAX submit).
     *
     * Note: this remains for classic WP_List_Table bulk submit fallback.
     * AJAX bulk is handled by NH_Dashboard_Actions::bulk_action_ajax().
     *
     * @since 1.6.2
     * @return void
     */
