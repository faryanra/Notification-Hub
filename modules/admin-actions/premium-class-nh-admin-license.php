...
class NH_Admin_License {
    ...
    public static function save_bundle(): void {
        ...
        if ($key !== '' && !preg_match('/^NH-PRO-[A-Z0-9]{4}-[A-Z0-9]{4}$/', $key)) {
            wp_safe_redirect(admin_url('admin.php?page=nh_settings&tab=premium&nh_license_error=invalid_key'));
            exit;
        }
        ...
        wp_safe_redirect(admin_url('admin.php?page=nh_settings&tab=premium&nh_license_saved=1'));
        exit;
    }
