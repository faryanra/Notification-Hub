<?php
/**
 * Mark Notification Unread Route
 *
 ...
 */
class Mark_Notification_Unread {
	...
	public function handle() {
		...
		$result = $this->repo->update( $id, array( 'status' => 'unread' ) );

		if ( $result ) {
			wp_send_json_success( array( 'message' => __( 'Notification marked as unread', 'notification-hub' ) ) );
		} else {
