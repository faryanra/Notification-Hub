...
if (!defined('NH_VERSION')) {
    add_action('admin_notices', function(){
        echo '<div class="notice notice-error"><p>Notification Hub Pro requires the free "Notification Hub" plugin to be installed and active.</p></div>';
    });
    return;
}
...
// ------------------------------------------------------
// Optional: Define Pro constants (if needed)
// ------------------------------------------------------
if (!defined('NH_PRO_VERSION')) {
    define('NH_PRO_VERSION', '1.6.0');
}
