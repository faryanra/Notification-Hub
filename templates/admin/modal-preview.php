 ...
 * Modal Preview
 *
 * Accessible modal used by the Notifications Dashboard to show notification details.
 *
...
<div id="nh-modal" class="nh-modal" role="dialog" aria-modal="true" aria-labelledby="nh-modal-title" aria-describedby="nh-modal-message" style="display:none;">
    ...
    <div class="nh-modal__content" role="document">
        <button type="button" class="nh-modal__close" aria-label="<?php esc_attr_e('Close dialog', 'notification-hub'); ?>">&times;</button>
