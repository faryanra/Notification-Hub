<?php
/**
 * Pro Channels Settings Fields
 *
 * Telegram / Slack settings gated by policy (NH_License::can()).
 *
 * Expects variables:
 * - bool $can_telegram
 * - bool $can_slack
...
<table class="form-table">
    <tr>
        ...
        <td>
            ...
            <?php if (!$can_telegram) : ?>
                <p class="description"><em><?php esc_html_e('This field is disabled because it’s only available in the Pro version.', 'notification-hub'); ?></em></p>
            <?php else : ?>
                <p>
                    <a
