<?php
/**
 * Pro Upgrade Panel (shown when Pro addon is not installed).
 *
...
<div class="nh-pro-upgrade">
    <h2><?php esc_html_e('Unlock Pro Channels', 'notification-hub'); ?></h2>

    <p><?php esc_html_e('Telegram and Slack integrations are part of Notification Hub Pro. Install the Pro addon to enable these channels and activate your license.', 'notification-hub'); ?></p>
